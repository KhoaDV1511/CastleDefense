...
/// <typeparam name="D">Fifth parameter type</typeparam>
public abstract class ASignal<T, U, V, W, D> : ABaseSignal
{
    private Action<T, U, V, W,D> callback;

    /// <summary>
    ///     Adds a listener to this Signal
    /// </summary>
    /// <param name="handler">Method to be called when signal is fired</param>
    public void AddListener(Action<T, U, V, W, D> handler)
    {
#if UNITY_EDITOR
        Debug.Assert(handler.Method.GetCustomAttributes(typeof(CompilerGeneratedAttribute), false).Length == 0,
            "Adding anonymous delegates as Signal callbacks is not supported (you wouldn't be able to unregister them later).");
    ...
    /// </summary>
    /// <param name="handler">Method to be unregistered from signal</param>
    public void RemoveListener(Action<T, U, V, W, D> handler)
    {
        callback -= handler;
    }
    ...
    ///     Dispatch this signal
    /// </summary>
    public void Dispatch(T arg1, U arg2, V arg3, W arg4, D arg5)
    {
        if (callback != null) callback(arg1, arg2, arg3, arg4, arg5);
    }
}